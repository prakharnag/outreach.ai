    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
      <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm sm:text-base font-medium text-blue-700">
        ...
        <CardContent>
          <div className="text-2xl sm:text-3xl font-bold text-blue-800 mb-1">
            {loading ? '...' : stats.companiesResearched}
          </div>
          <p className="text-xs sm:text-sm text-blue-600">
            Total company profiles analyzed
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm sm:text-base font-medium text-green-700">
      ...
      <Card className="bg-gradient-to-br from-purple-50 to-violet-50 border-purple-200 sm:col-span-2 lg:col-span-1">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm sm:text-base font-medium text-purple-700">
        ...
        <CardContent>
          <div className="text-2xl sm:text-3xl font-bold text-purple-800 mb-1">
            {loading ? '...' : stats.successfulInferences}
          </div>
          <p className="text-xs sm:text-sm text-purple-600">
            Complete research inferences
          </p>
        </CardContent>
      </Card>
    </div>
